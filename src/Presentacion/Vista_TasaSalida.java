...
public class Vista_TasaSalida extends javax.swing.JInternalFrame {

  
    public Vista_TasaSalida() {
        initComponents();
        mostrar("","");
        //this.setLocationRelativeTo(null);
        Label.setIcon(new ImageIcon(getClass().getResource("/Files/6.png")));
    }
        void mostrar(String Fecha1,String Fecha2) {
        try {
            DefaultTableModel modelo;
            FVenta func = new FVenta();
            modelo = func.mostrarTasaSalida(Fecha1,Fecha2);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Recaudacion por concepto de tasa de salida");
        ...
        jButton_Buscar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Files/if_search_b_44994.png"))); // NOI18N
        ...
        jLabel_Salida3.setText("-");

        Label.setPreferredSize(new java.awt.Dimension(128, 128));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vista_TasaSalida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vista_TasaSalida().setVisible(true);
            }
        });
    }
